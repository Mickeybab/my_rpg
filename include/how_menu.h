...
#define STR_TEXT_2 {"Click on the map to move your player.\n"\
		"You can use the left shift + the right click to attack.\n"\
		"Use the key 'i' to open your inventory.\n"\
		"Use the key 's' to open your skill tree.\n"\
		"\tOn your skill tree, you can spend some compentecies\n\t"\
		"point, to improve your capacities.\n"\
		"You will lose some HP as you get hit by the enemies.\n"\
		"You will also lose some MANA as you use your spells.\n"\
		"The purpose of the game is to complete the mazes, and to\n"\
		"explore the open-world.\n"\
}
#define STR_TEXT_3 "Back"
#define STR_TEXT_4 "Quit"
#define SIZE_TEXT_MAX 10000
